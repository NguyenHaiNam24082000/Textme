...
const Fire = () => {
  return (
    <svg
      className="absolute -bottom-1 -left-1 -right-1 h-auto"
      style={{ width: "calc(100% + 12px)", zIndex: 1 }}
      version="1.1"
      id="Layer_1"
...
const Flame = () => {
  return (
    <div className="w-full h-full overflow-hidden absolute top-0 left-0 right-0 bottom-0">
      <div className="fire">
