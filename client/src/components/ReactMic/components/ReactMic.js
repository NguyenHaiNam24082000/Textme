...
export default class ReactMic extends Component {
  ...
  visualize() {
    ...
    if (visualSetting === "sinewave") {
      this.drawer = VisualizerMain.visualizeSineWave(
        canvasCtx,
        canvas,
        width,
        height,
      ...
      this.drawer = VisualizerMain.visualizeFrequencyBars(
        canvasCtx,
        canvas,
        width,
        height,
      ...
      this.drawer = VisualizerMain.visualizeFrequencyCircles(
        canvasCtx,
        canvas,
        width,
        height,
