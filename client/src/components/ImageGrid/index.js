...
export default function ImageGrid({ countFrom = 5 }) {
  const [count, setCount] = useState(() => {
    return countFrom > 0 && countFrom < 5 ? countFrom : 5;
  });
  const images = [
    {
      albumId: 1,
  ...
  return (
    <Grid grow gutter="xs" className="w-full h-full flex-1 overflow-y-auto basis-0">
